...
export default function Volume5() {
    return (<>
        <p>
            What is up my dudes, Bee’s back on her bullsh*t again so let’s roll on this edition of Times: the best place to get your digest of guild activity and thoughtful insights into all things Wynn! Some fun new news updates, a special interview, and a bit of media I’m quite proud of are all in this one so be sure to read to the end!
        </p>
        <h2>
            Recent Happenings 📅
        </h2>
        ...
        <p>
            <strong>
                Beta is currently open to all players.
            </strong>
        </p>
        <p>
        ...
        <p>
            Did you know that BlueTheSniper has his own discord server dedicated to Wynncraft builds? Did you also know that Blue created an exclusive ANO role in his server that automatically grants all Titans Valor members VIP status? Did you want to have access to a huge database of all types of builds that are updated daily by other players? If any of these things sound good to you, make sure you head over to <a href="https://discord.gg/pBmcXY8H9U">
                Blue's Builds
            </a>
            .
    </p>
    ...
    <div className="indented">
        <p>
            <strong>
                Lucky32, Hothotrod, BlueTheSniper, bmarci04, CensingMarker51, HadesRPB, CatgirlZyris, OblivionEnjoyer, Masterfuzja, Emeraldglass, ItsEmerald, robopig3000
            </strong>
            , and <strong>
                _Constellar
            </strong> have all been promoted to Sorcerer!
        </p>
        <p>
            <strong>
                Habidudi
            </strong> has been promoted to Artificer!
        </p>
        <p>
            <strong>
                Biblonko
    ...
    <p>
        With the season ending, that also means the end of another season of Ocean Trials come and gone! For anyone who doesn’t already know, Ocean Trials is an event we hold every season in which you can war for LE. At the top of the leaderboard this season was none other than <strong>
            GebutterteWurst
        </strong>
        ! Other honorable mentions were <strong>
            LaMDaKis
        </strong> in 2nd and <strong>
            Callum
        </strong> in 3rd. Hopefully this event will be returning next season after the release of 2.0, but if you want to stay updated on the latest information, make sure you grab the role from #military-info!
    </p>
    <h2>
    ...
    <div className="indented">
        <h4 id="whats-your-favorite-thing-to-do-on-wynn">
    ...
    <p>
        <strong>
            Nimbuh
        </strong>, for contributing over 100 bombs to our bomb party recently
    </p>
    <TriviaFact>
